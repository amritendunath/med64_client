  ...
  const [appointments, setAppointments] = useState([]);
    ...
    const fetchData = async () => {
      try {
        ...
        const chatSessionsResponse = await fetch('http://localhost:8000/api/v1/generate-stream/chat-sessions', {
          method: 'GET',
          headers: {
      ...
      try {
        ...
        const appointmentsResponse = await fetch('http://localhost:8000/api/v1/generate-stream/appointment/', {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`,
