...
const options = [
    {
        ...
        icon: <HiOutlineBolt size={22} color="#ffffff" className=' mr-4' />,
    ...
    },
    {
        ...
        icon: <GiBrain size={22} color="#ffffff" className=' mr-4' />,
        ...
        >
            <div className="relative ">
                ...
                <Listbox.Options
                    ...
                    className="min-w-[260px] absolute bottom-full mb-1 p-[5px] w-full bg-[rgba(32,37,49,0.95)] rounded-[10px] shadow-lg z-10 transition-all  outline-none ">
                    {options.map((option) => (
                        <Listbox.Option
                            key={option.value}
                            value={option.value}
